...
'''
1. We'll need a Grid class of M x N
2. We'll need to keep track of the state of the positions in the Grid (null, red, yellow).
3. We'll need a method to add a piece (red, yellow) at a position in the Grid
4. We'll need a Player class
5. This should all exist within a Game class
